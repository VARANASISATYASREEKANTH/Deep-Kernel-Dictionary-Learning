...
#Encoder
lstm_autoencoder.add(LSTM(4, activation='relu', input_shape=(timesteps, n_features), return_sequences=True));
lstm_autoencoder.add(LSTM(2, activation='relu', return_sequences=False));
...
q=lstm_autoencoder_history['loss'];
