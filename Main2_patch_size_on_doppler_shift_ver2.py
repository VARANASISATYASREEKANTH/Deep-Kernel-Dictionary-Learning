...
from Functions import denoising
...
ratio =2# Ratio for the dictionary (training set).
ksvd_iter =2              # Number of iterations for the K-SVD.
#-------------------------------------------------------------------------------------------------------------------#
#--------------------------------------------------- 2. data import ----------------------------------------------#
#-----------------------------------------------photon count data--------------------------------------------------------------------#

loc_d = ('G:/research_works_vssreekanth_jrf/MY_PAPERS/paper_3a_deep_learning_for_parameter_estimation/programs/anamoly_detection_LSTM_RNN/training_data/wave_breaking_train_data_ver2.xlsx')
...
loc_d = ('G:/research_works_vssreekanth_jrf/MY_PAPERS/paper_3a_deep_learning_for_parameter_estimation/programs/anamoly_detection_LSTM_RNN/test_data_21_04_2014_ver2.xlsx')
wb = xlrd.open_workbook(loc_d)
sheet = wb.sheet_by_index(0)
sheet.cell_value(0, 0)
