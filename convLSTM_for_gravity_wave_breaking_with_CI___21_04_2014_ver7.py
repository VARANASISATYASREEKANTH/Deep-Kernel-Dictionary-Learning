...
#ax.set_title('Wave Breaking Detection using Deep Dictionary Learning' )
...
plt.figure(2)
ax=plt.subplot(1,1,1)
s = pd.Series(spe_metric[1][1:128]);
...
x=np.transpose(spe_metric[1:128][1]);
y=spe_metric[1][1:128]
xmin, xmax = -2, 2
ymin, ymax = -2, 2
