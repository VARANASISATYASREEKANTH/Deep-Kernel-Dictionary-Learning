...
loc1=('G:/research_works_vssreekanth_jrf/MY_PAPERS/paper_3a_deep_learning_for_parameter_estimation/programs/anamoly_detection_LSTM_RNN/meridonal_wind_18_10_2018_ver2_without_wb.xlsx')
wb = xlrd.open_workbook(loc1)
sheet = wb.sheet_by_index(0)
