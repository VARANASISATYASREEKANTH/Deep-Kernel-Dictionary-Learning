...
name = ('G:/research_works_vssreekanth_jrf/MY_PAPERS/sparsity_including_norms_on_frame_expansion/programs/compressive_sensing_sparsity/input1')
...
imsave(name + '1 - Greysc image.png', Image.fromarray(np.uint8(original_image)))
imsave(name + '2 - Noisy image.png', Image.fromarray(np.uint8(noisy_image)))
...
imsave('denoised_image' + '.jpg', Image.fromarray(np.uint8(denoised_image)))
